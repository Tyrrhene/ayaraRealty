...
export const post3: (args: PostArgs) => RequiredDataFromCollectionSlug<'posts'> = ({
  ...
  return {
    ...
    availableUnits: [], // if this is a relation, put unit IDs here later

    // If your relation expects IDs at create time, use [author.id] instead
    authors: [author],
      ...
      root: {
        ...
        children: [
          ...
          },
          {
            type: 'heading',
            children: [
              { type: 'text', detail: 0, format: 0, mode: 'normal', style: '', text: "Money isn't just currency; ", version: 1 },
              { type: 'text', detail: 0, format: 2, mode: 'normal', style: '', text: "it's a language. ", version: 1 },
              { type: 'text', detail: 0, format: 0, mode: 'normal', style: '', text: 'Dive deep into its nuances, where strategy meets intuition in the vast sea of finance.', version: 1 },
            ],
            direction: 'ltr',
            format: '',
            indent: 0,
