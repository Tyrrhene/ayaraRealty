      ...
      <div className="px-[40px]">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
          {paginatedProperties.map((property) => {
            const images = (property.images ?? []).map((imgObj) => imgObj.image)
            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  {hasImages ? (
                    // Carousel fits small cards; first image eager, arrows only on hover, safe inside <Link>
                    <ImageCarouselCard
                      images={images}
                      aspectRatio="4 / 3" // adjust to taste, e.g. "3 / 2" or "16 / 9"
                      // unoptimized // uncomment if remote domains aren't in next.config.js images.domains
                    />
                  ) : (
