...
export const AvailableUnitsBlock: React.FC<{
  id?: string
  introContent?: any
  properties: Property[]
  ...
  return (
    <div className="pd-0" id={`block-${id}`}>
      ...
      <div className="mx-auto max-w-7xl">
        {/* Auto-fit grid so cards expand naturally without looking squashed */}
                ...
                <div className="mt-4 space-y-2">
                  <div className="flex flex-wrap gap-x-6 gap-y-2">
                    <div className="flex items-center">
                      <img src="https://img.icons8.com/windows/24/null/bedroom.png" alt="" />
                      <p className="ml-2 text-sm font-medium text-gray-700">
                        {property.bedrooms} Bedrooms
                      </p>
                    </div>
                    <div className="flex items-center">
                      <img src="https://img.icons8.com/pastel-glyph/24/null/bath--v2.png" alt="" />
                      <p className="ml-2 text-sm font-medium text-gray-700">
                        {property.bathrooms} Bathrooms
                      </p>
                    </div>
                    <div className="flex items-center">
                      <img src="https://img.icons8.com/ios-glyphs/24/null/expand--v1.png" alt="" />
                      <p className="ml-2 text-sm font-medium text-gray-700">
